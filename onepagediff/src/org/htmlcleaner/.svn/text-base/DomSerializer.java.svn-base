 ...
 * 
 * Created by: Vladimir Nikic<br/> Date: April, 2007.
 */
public class DomSerializer {
  ...
  private void createSubnodes(Document document, Element element,
    List tagChildren) {
    if (tagChildren != null) {
      ...
      while (it.hasNext()) {
        ...
        if (item instanceof CommentToken) {
          ...
          element.appendChild(specialCase ? document
            .createCDATASection(content) : document.createTextNode(content));
        }
