 ...
 * 
 * Created by: Vladimir Nikic, Benson Margulies <br/> Date: April, 2007.
 */
    ...
    if (tagChildren != null) {
      ...
      while (it.hasNext()) {
        ...
        if (item instanceof CommentToken) {
          ...
          Text text = specialCase ? factory.cdata(content) : factory
            .text(content);
          ...
          while (entryIterator.hasNext()) {
            ...
            if (Verifier.checkAttributeName(attrName) == null) {
