...
public class DomTreeBuilder
  ...
  private boolean ignoreNonViewableImages = true;
  ...
  public boolean isIgnoreNonViewableImages() {
    return ignoreNonViewableImages;
  }

  public void setIgnoreNonViewableImages(boolean ignoreNonViewableImages) {
    this.ignoreNonViewableImages = ignoreNonViewableImages;
  }
  ...
  public void endElement(String uri, String localName, String qName)
    ...
    if (localName.equalsIgnoreCase("body")) {
      ...
      if (localName.equalsIgnoreCase("img")) {
        ...
        lastSibling = img;
        if (!ignoreNonViewableImages
          || (ignoreNonViewableImages && isViewableImage(img))) {
          textNodes.add(img);
        }
      }
      endWord();
