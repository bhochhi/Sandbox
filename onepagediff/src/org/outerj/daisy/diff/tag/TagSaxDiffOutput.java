...
public class TagSaxDiffOutput {
  ...
  public TagSaxDiffOutput(ContentHandler consumer)
    throws SAXException {
    this.consumer = consumer;
  }

  public void addClearPart(String text)
    throws Exception {
    addBasicText(text);
  }
  ...
  private void addBasicText(String text)
    throws SAXException {
  ...
  public void addRemovedPart(String text)
    throws Exception {
    AttributesImpl attrs = new AttributesImpl();
  ...
  public void addAddedPart(String text)
    throws Exception {
    AttributesImpl attrs = new AttributesImpl();
