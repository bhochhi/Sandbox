...
/* package */class OldDifferencer {
  ...
  /*
   * Creates a Vector of DifferencesRanges out of the LinkedRangeDifference. It
   * coalesces adjacent changes. In addition, indices are changed such that the
   * ranges are 1) open, i.e, the end of the range is not included, and 2) are
   * zero based.
   */
